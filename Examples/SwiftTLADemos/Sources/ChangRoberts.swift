    ...
    public static var spec: TLASpec {
        #spec("ChangRoberts") {
            Algorithm("ChangRoberts", scoped: { scope in
                let identifiers = scope.sharedVar(initial: Function<Node, Int>.literal(
                    (.one, 8), (.two, 2), (.three, 11), (.four, 9),
                    (.five, 12), (.six, 3), (.seven, 1), (.eight, 5),
                    (.nine, 10), (.ten, 6), (.eleven, 4), (.twelve, 7)
                ))
                let next = scope.sharedVar(initial: Function<Node, Node>.literal(
                    (.one, .two), (.two, .three), (.three, .four), (.four, .five),
                    (.five, .six), (.six, .seven), (.seven, .eight), (.eight, .nine),
                    (.nine, .ten), (.ten, .eleven), (.eleven, .twelve), (.twelve, .one)
                ))
                let messages = scope.sharedVar(initial: SetExpr<Record<MessageSchema>>.literal(
