...
public enum Examples {
    public static let all: [ExampleDescription] = [
        ...
        .init(name: "CoffeeCan", spec: CoffeeCan.spec, expectedStates: 0, source: "specifications/CoffeeCan", about: "Bean removal puzzle."),
        .init(name: "MovingCat", spec: MovingCat.spec, expectedStates: 24, source: "specifications/Moving_Cat_Puzzle", about: "Cat bouncing between boxes."),
        .init(name: "Majority", spec: Majority.spec, expectedStates: 0, source: "specifications/Majority", about: "Boyer-Moore majority vote."),
        ...
        .init(name: "Allocator", spec: Allocator.spec, expectedStates: 0, source: "specifications/allocator", about: "Resource allocator."),
    ]
}
