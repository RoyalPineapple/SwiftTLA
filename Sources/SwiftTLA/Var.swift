...
extension StateExpr {
    ...
    public func filtering(_ predicate: StateExpr) -> StateExpr { .setFilter(self, FreshVarName.fresh(), predicate) }
    public func mapping(_ expression: StateExpr) -> StateExpr { .setMap(expression, FreshVarName.fresh(), self) }
