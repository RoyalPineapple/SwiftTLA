...
extension TLASpec {
    func specializing(parameters: [String: StateExpr]) -> TLASpec {
        ...
        return TLASpec(
            ...
            actions: actions.map { .init(name: $0.name, body: action($0.body), bindings: $0.bindings, controlOwner: $0.controlOwner, generatedSymmetricCollectionName: $0.generatedSymmetricCollectionName) },
