...
require "submodules: false"
require "Initialize pinned core-conformance baseline"
require "git submodule update --init --depth=1 Verification/CoreConformance/baselines"
forbid "submodules: recursive"
forbid "academic"
