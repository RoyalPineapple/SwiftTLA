...
struct TLCTemporalAdapterTests {
  ...
  func blocksForeignOrIncompleteEvidence() throws {
    ...
    let foreignCorrelation = try TemporalSymmetryCaseOutcomeCorrelation(
  ...
  private final class Fixture {
    ...
    let correlation: TemporalSymmetryCaseOutcomeCorrelation
    ...
    init() throws {
      ...
      correlation = try TemporalSymmetryCaseOutcomeCorrelation(
    ...
    func input(
      ...
      correlation: TemporalSymmetryCaseOutcomeCorrelation? = nil,
